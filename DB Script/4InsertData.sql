...
INSERT INTO TEAM_COACH VALUES (1,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=1),
	(SELECT REF(C) FROM COACH C WHERE C.ID=1),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (2,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=1),
	(SELECT REF(C) FROM COACH C WHERE C.ID=2),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (3,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=2),
	(SELECT REF(C) FROM COACH C WHERE C.ID=1),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (4,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=2),
	(SELECT REF(C) FROM COACH C WHERE C.ID=3),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (5,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=3),
	(SELECT REF(C) FROM COACH C WHERE C.ID=4),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (6,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=3),
	(SELECT REF(C) FROM COACH C WHERE C.ID=5),
	SYSDATE, SYSDATE + 365
)
/
INSERT INTO TEAM_COACH VALUES (7,
	(SELECT REF(T) FROM TEAM T WHERE T.ID=4),
	(SELECT REF(C) FROM COACH C WHERE C.ID=5),
	SYSDATE, SYSDATE + 365
)
/
...
INSERT INTO CLUB_PLAYER VALUES (1,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=1),SYSDATE - 2000);
INSERT INTO CLUB_PLAYER VALUES (2,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=2),SYSDATE - 800);
INSERT INTO CLUB_PLAYER VALUES (3,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=3),SYSDATE - 1300);
INSERT INTO CLUB_PLAYER VALUES (4,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=4),SYSDATE - 1900);
INSERT INTO CLUB_PLAYER VALUES (5,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=5),SYSDATE - 1800);
INSERT INTO CLUB_PLAYER VALUES (6,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=6),SYSDATE - 2100);
INSERT INTO CLUB_PLAYER VALUES (7,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=7),SYSDATE - 350);
INSERT INTO CLUB_PLAYER VALUES (8,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=8),SYSDATE - 670);
INSERT INTO CLUB_PLAYER VALUES (9,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=9),SYSDATE - 200);
INSERT INTO CLUB_PLAYER VALUES (10,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=10),SYSDATE - 1000);
INSERT INTO CLUB_PLAYER VALUES (11,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=11),SYSDATE - 2000);
INSERT INTO CLUB_PLAYER VALUES (12,(SELECT REF(C) FROM CLUB C WHERE C.ID=1),(SELECT REF(P) FROM PLAYER P WHERE P.ID=12),SYSDATE - 600);
INSERT INTO CLUB_PLAYER VALUES (13,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=13),SYSDATE - 659);
INSERT INTO CLUB_PLAYER VALUES (14,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=14),SYSDATE - 347);
INSERT INTO CLUB_PLAYER VALUES (15,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=15),SYSDATE - 865);
INSERT INTO CLUB_PLAYER VALUES (16,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=16),SYSDATE - 336);
INSERT INTO CLUB_PLAYER VALUES (17,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=17),SYSDATE - 744);
INSERT INTO CLUB_PLAYER VALUES (18,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=18),SYSDATE - 447);
INSERT INTO CLUB_PLAYER VALUES (19,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=19),SYSDATE - 743);
INSERT INTO CLUB_PLAYER VALUES (20,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=20),SYSDATE - 346);
INSERT INTO CLUB_PLAYER VALUES (21,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=21),SYSDATE - 84);
INSERT INTO CLUB_PLAYER VALUES (22,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=22),SYSDATE - 754);
INSERT INTO CLUB_PLAYER VALUES (23,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=23),SYSDATE - 333);
INSERT INTO CLUB_PLAYER VALUES (24,(SELECT REF(C) FROM CLUB C WHERE C.ID=2),(SELECT REF(P) FROM PLAYER P WHERE P.ID=24),SYSDATE - 451);
