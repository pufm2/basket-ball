...
INSERT INTO OFFICE VALUES (
    ...
    'OFFICE 1',T_ADDRESS (2,'TAN VIEN','TAN BINH','HCMC'), 0);
INSERT INTO OFFICE VALUES (
    2,
    SDO_GEOMETRY (
        2001, -- SDO_GTYPE attribute: "2" in 2001 specifies dimensionality is 2.
...
INSERT INTO OFFICE VALUES (
    ...
    'OFFICE 4',T_ADDRESS (1,'LOT 10 QTSP','12','Da Lat city'), 0);
INSERT INTO OFFICE VALUES (
    5,
    SDO_GEOMETRY (
        2001, -- SDO_GTYPE attribute: "2" in 2001 specifies dimensionality is 2.
...
(
	1,'PLAYER 1', 0, '100001',TO_DATE('18/03/1980','DD/MM/YYYY'),T_ADDRESS ('4','PHAN TON','1','HCMC'),
	T_TEAM_WITH_PLAYER(
...
INSERT INTO PLAYER VALUES 
(
	2,'PLAYER 2', 0, '200001',TO_DATE('18/06/1986','DD/MM/YYYY'),T_ADDRESS ('35','PHAN KE BINH','1','HCMC'),
	T_TEAM_WITH_PLAYER(
		T_TEAM_MANY((SELECT REF(T) FROM TEAM T WHERE T.ID = 1),SYSDATE,NULL),
		T_TEAM_MANY((SELECT REF(T) FROM TEAM T WHERE T.ID = 2),SYSDATE-300,SYSDATE-200)
	)
...
INSERT INTO PLAYER VALUES 
(
	4,'PLAYER 4', 0, '400001',TO_DATE('12/09/1984','DD/MM/YYYY'),T_ADDRESS ('9/4','YET KIEU','HOAN KIEM','HA NOI'),
	T_TEAM_WITH_PLAYER(
		T_TEAM_MANY((SELECT REF(T) FROM TEAM T WHERE T.ID = 1),SYSDATE,NULL),
		T_TEAM_MANY((SELECT REF(T) FROM TEAM T WHERE T.ID = 2),SYSDATE-300,SYSDATE-200)
	)
...
INSERT INTO PLAYER VALUES 
(
	5,'PLAYER 5', 0, '500001',TO_DATE('07/05/1981','DD/MM/YYYY'),T_ADDRESS ('18A','LE VAN SY','3','HCMC'),
	T_TEAM_WITH_PLAYER(
...
INSERT INTO PLAYER VALUES 
(
	6,'PLAYER 6', 0, '600001',TO_DATE('18/03/1982','DD/MM/YYYY'),T_ADDRESS ('4','PHAN TON','1','HCMC'),
	T_TEAM_WITH_PLAYER(
...
INSERT INTO PLAYER VALUES 
(
	7,'PLAYER 7', 0, '700001',TO_DATE('01/06/1988','DD/MM/YYYY'),T_ADDRESS ('35','PHAN KE BINH','1','HCMC'),
	T_TEAM_WITH_PLAYER(
		T_TEAM_MANY((SELECT REF(T) FROM TEAM T WHERE T.ID = 1),SYSDATE,NULL),
...
INSERT INTO PLAYER VALUES 
(
	8,'PLAYER 8', 0, '800001',TO_DATE('20/05/1979','DD/MM/YYYY'),T_ADDRESS ('27/3A','TRAN NHAN TONG','BA DINH','HA NOI'),
	T_TEAM_WITH_PLAYER(
...
INSERT INTO CATEGORY VALUES (1,'CATEGORY 1 - FIRST',T_TEAMS(), 0);
...
INSERT INTO CATEGORY VALUES (2,'CATEGORY 2 - SECOND',T_TEAMS(), 0);
...
INSERT INTO CATEGORY VALUES (3,'CATEGORY 3 - THIRD',T_TEAMS(), 0);
...
INSERT INTO CATEGORY VALUES (4,'CATEGORY 4 - FORTH',T_TEAMS(), 0);
