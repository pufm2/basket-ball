...
INSERT INTO MATCH VALUES (1, SYSDATE, (SELECT REF(S) FROM SEASON S WHERE ID=1), T_SCOREDETAILS(), 0);
...
INSERT INTO MATCH VALUES (2, SYSDATE-100, (SELECT REF(S) FROM SEASON S WHERE ID=2), T_SCOREDETAILS(), 0);
