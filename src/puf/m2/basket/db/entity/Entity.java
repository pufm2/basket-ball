...
public abstract class Entity {
    ...
    public <T> T getRef(Class<T> clazz) throws BasketException {
        ...
        try {
            ...
            String stmtString = "SELECT ref(t) FROM " + tableName + " t where id = " + getId();
            ...
            if (orset.next()) {
                return (T) orset.getORAData(1, oraDataFactory);
            }
        } catch (Exception e) {
    ...
    public void getDbProps(Map<String, Object> dbProps, Class<?> clazz) throws BasketException  {
    ...
    public void update() throws BasketException {
        ...
        try {
            String tableName = (String) getClass().getField("TABLE_NAME").get(null);
            StringBuffer stmt = new StringBuffer("update " + tableName + " set ");
