...
public class SdoOrdinateArray implements ORAData, ORADataFactory {
    public static final String _SQL_NAME = "MDSYS.SDO_ORDINATE_ARRAY";
    public static final int _SQL_TYPECODE = OracleTypes.ARRAY;

    MutableArray _array;

    private static final SdoOrdinateArray _SdoOrdinateArrayFactory = new SdoOrdinateArray();

    public static ORADataFactory getORADataFactory() {
        return _SdoOrdinateArrayFactory;
    }
    ...
    public SdoOrdinateArray(java.math.BigDecimal[] a) {
    ...
    public ORAData create(Datum d, int sqlType) throws SQLException {
        if (d == null)
            return null;
        SdoOrdinateArray a = new SdoOrdinateArray();
