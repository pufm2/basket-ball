...
public class MainForm extends javax.swing.JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if ("ManageCategory".equals(e.getActionCommand())) {
			...
			Utils.createAndShowGUI(new JFrame("Manage club"),
					new ClubView());
			...
			Utils.createAndShowGUI(new JFrame("Manage team"),
					new TeamView());
		} else if ("ClubPlayer".equals(e.getActionCommand())) {
			Utils.createAndShowGUI(new JFrame("Manage players in club"),
					new ClubPlayerView());
		} else if ("TeamCoach".equals(e.getActionCommand())) {
			Utils.createAndShowGUI(new JFrame("Manage coaches for teams"),
					new TeamCoachView());
		}
	}
