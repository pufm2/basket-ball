...
public class AvgScoreOfDateView extends javax.swing.JPanel implements
		ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (result != 0) {
			...
			lblResult.setText("Average of score points be meeting at "
					+ formatter.format(dateOfMatch) + " is "
