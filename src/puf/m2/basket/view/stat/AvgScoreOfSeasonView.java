...
public class AvgScoreOfSeasonView extends javax.swing.JPanel implements ActionListener{
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cboSeason, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(78, 78, 78)
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (result!=0) {
			lblResult.setText("Average of score points since the beginning of the season is " + String.valueOf(result));
		}
		else{
