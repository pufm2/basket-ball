...
public class Player extends DbPlayer {
    ...
    public Player(Integer id, String personName, String playerLicenceNumber,
            java.sql.Timestamp playerBirthday, Address playerAddress,
            DbTeamWithPlayer teamWithPlayers) throws SQLException {
        super(id, personName, playerLicenceNumber, playerBirthday, playerAddress, teamWithPlayers);
    }
    ...
    public static List<Player> loadAll() throws BasketException {

        List<Player> players = EntityUtils.loadByCondition(null, Player.class);
        return players;
    }
    ...
    public void save() throws BasketException {
        ...
        try {
            ...
            setTeamWithPlayers(new DbTeamWithPlayer(tmList.toArray(new DbTeamMany[]{})));
